...
# It makes the program easier to update, for example, if I want to change the tax I only need to change it in one place.
...
def show_products():
    ...
    I used a for loop, and it also reads from the product dictionary.
    """
    print("\n========= PRODUCT CATALOG =========")
...
# This is to view all items currently in the cart.
